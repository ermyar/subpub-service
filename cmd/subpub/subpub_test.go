...
func TestSubPub_single(t *testing.T) {
	p := NewSubPub()
...
func TestSubPub_nonBlockPublish(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_multipleSubjects(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_multipleSubscribers(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_slowpoke(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_sequencePublishers(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_concurrentPublishers(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_msgOrder(t *testing.T) {
	p := NewSubPub()
	defer checkedClose(t, p)
...
func TestSubPub_failAfterClose(t *testing.T) {
	p := NewSubPub()
...
func TestSubPub_closeWaitsMessageDelivery(t *testing.T) {
	p := NewSubPub()
